...
public class DataManager {
    ...
    /** Actions configured for in wifi area category key initiator */
    public static final String CATEGORY_ACTIONS_ARRIVING = "category_actions_arriving_";

    /** Actions configured for out of wifi area category key initiator */
    public static final String CATEGORY_ACTIONS_LEAVING = "category_actions_leaving_";
    ...
    public static int getRingerMode(Context context, Bundle stateData) {
        ...
        if (wifiState == StateEvent.CON) {
            mode = p.getString("preference_action_arriving_ringer_mode_" + wifi, context.getString(R.string.preference_ringer_mode_default));
        } else if (cellState == StateEvent.OUT) {
            mode = p.getString("preference_action_leaving_ringer_mode_" + wifi, context.getString(R.string.preference_ringer_mode_default));
        }
        if (mode == null) {
            result = -1;
        } else if (mode.equals(context.getString(R.string.preference_ringer_mode_normal))) {
            result = AudioManager.RINGER_MODE_NORMAL;
        } else if (mode.equals(context.getString(R.string.preference_ringer_mode_silent))) {
            result = AudioManager.RINGER_MODE_SILENT;
        } else if (mode.equals(context.getString(R.string.preference_ringer_mode_vibrate))) {
